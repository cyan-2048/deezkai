...
export default function Home() {
	useInViewEffect(() => {
		...
		const enter = register("Enter", () => {
			const currentIndex = focusedIndex.peek();
			if (currentIndex == 3) {
		...
		return () => {
			console.log("homescreen no longer focused");
			unregister(downkey, upkey, enter);
		};
	});
	...
	return (
		<main>
			...
			<div class={styles.body}>
				<div style={{ top: focusedIndex.value * 66 }} class={styles["focus-item"]}></div>
				<HomeListItem title="Tracks" description="Find your music">
					<svg class={(focusedIndex.value == 0 || "") && styles.iconFocus} xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16">
				...
				<HomeListItem title="Albums" description="Search for albums">
					<svg class={(focusedIndex.value == 1 || "") && styles.iconFocus} xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16">
				...
				<HomeListItem title="Artists" description="Search for artists">
					<svg class={(focusedIndex.value == 2 || "") && styles.iconFocus} xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16">
						<path d="M6 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm-5 6s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H1zM11 3.5a.5.5 0 0 1 .5-.5h4a.5.5 0 0 1 0 1h-4a.5.5 0 0 1-.5-.5zm.5 2.5a.5.5 0 0 0 0 1h4a.5.5 0 0 0 0-1h-4zm2 3a.5.5 0 0 0 0 1h2a.5.5 0 0 0 0-1h-2zm0 3a.5.5 0 0 0 0 1h2a.5.5 0 0 0 0-1h-2z" />
					</svg>
				</HomeListItem>
				<HomeListItem title="Downloads" description="Listen to music offline">
					<svg class={(focusedIndex.value == 3 || "") && styles.iconFocus} xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 16 16">
